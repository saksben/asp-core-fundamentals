...
namespace BethanysPieShopTests.Mocks
{
    public class RepositoryMocks
    {
        ...
        public static Mock<IPieRepository> GetPieRepository()
        {
            ...
            // Sets up mock repo actions so that you can get all pies, get a pie that is pieOfTheWeek, and gets the first pie of the list when a user gives an integer id
